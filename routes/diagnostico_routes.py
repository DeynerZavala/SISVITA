...
from utils.SendEmail import enviar_correo_diagnostico
...
def create_diagnostico():
   try:
       ...
       especialistatemp= Especialistas.query.get(especialista_id)
       tratamiento = Tratamientos.query.get(tratamiento_id)
